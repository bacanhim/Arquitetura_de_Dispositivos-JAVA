 ...
 * @author Turma A
 */
public class sonnar extends javax.swing.JFrame {
        ...
        public void run() {
            ...
            synchronized (lockobj) {
                try {
                    ...
                    Logger.getLogger(sonnar.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
            try {
                Thread.sleep(5000);
    ...
    public sonnar() throws URISyntaxException, IOException, InterruptedException {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(sonnar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
